...
const getWeather = async (lat, lon) => {
    api = 'b23222e676c4424fc8a037fca14ee913';
...
const deg = document.querySelector('.degree-section h3');
        ...
        .then(locData => {
            ...
            getWeather(locData.lat, locData.lon)
                .then(weData => {
                    ...
                    //Change the icon with temperature
                    const iconName = getIcon(weMain);
                    icon.innerHTML = `<img src='icons/${iconName}'></img>`;

                    //Change the temperature display unit by clicking
